                        ...
                        <form onSubmit={handleUpdatePromotion}>
                            <div className="form-group">
                                ...
                                <input
                                    type="text"
                                    name="tenKhuyenMai"
                                    defaultValue={editPromotion.TenKhuyenMai}
                                    required
                                />
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <select
                                    name="loaiGiamGia"
                                    defaultValue={editPromotion.LoaiGiamGia}
                                    required
                                >
                                    <option value="PhanTram">Phần trăm</option>
                                    <option value="SoTien">Số tiền</option>
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    name="giaTriGiam"
                                    step="1"
                                    defaultValue={editPromotion.GiaTriGiam}
                                    required
                                />
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    name="ngayBatDau"
                                    defaultValue={
                                        editPromotion.NgayBatDau
                                            ? editPromotion.NgayBatDau.slice(0, 10)
                                            : ""
                                    }
                                    required
                                />
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    name="ngayKetThuc"
                                    defaultValue={
                                        editPromotion.NgayKetThuc
                                            ? editPromotion.NgayKetThuc.slice(0, 10)
                                            : ""
                                    }
                                    required
                                />
                                    ...
                                    <tr key={item.MaKhuyenMai}>
                                        ...
                                        <td>
                                            <div className="promo-actions">
                                                <button className="btn-edit" onClick={() => handleEditPromotion(item)}>
                                                    Sửa
                                                </button>
